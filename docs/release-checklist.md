...
4. Run `savemyterminal --version`, `savemyterminal doctor`, and a short `savemyterminal run -- <command>` smoke test.
...
4. Download one uploaded artifact, verify its checksum, install it, and run `savemyterminal --version`.
